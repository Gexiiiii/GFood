...
/** 
 * DAO for table "t_look_history".
*/
public class LookHistoryBeanDao extends AbstractDao<LookHistoryBean, String> {

    public static final String TABLENAME = "t_look_history";

    /**
     * Properties of entity LookHistoryBean.<br/>
    ...
    public LookHistoryBeanDao(DaoConfig config) {
        super(config);
    }
    
    public LookHistoryBeanDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"t_look_history\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"t_look_history\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, LookHistoryBean entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, LookHistoryBean entity) {
        stmt.clearBindings();
    ...
    @Override
    public LookHistoryBean readEntity(Cursor cursor, int offset) {
        LookHistoryBean entity = new LookHistoryBean( //
    ...
    @Override
    public void readEntity(Cursor cursor, LookHistoryBean entity, int offset) {
    ...
    @Override
    protected final String updateKeyAfterInsert(LookHistoryBean entity, long rowId) {
        return entity.getId();
    }
    
    @Override
    public String getKey(LookHistoryBean entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(LookHistoryBean entity) {
